...
class MixedMaskEmbedder:
    def __init__(self, irregular_proba=0.6, irregular_kwargs=None,
                 box_proba=0.4, box_kwargs=None,
        ...
        if irregular_kwargs is None:
            irregular_kwargs = {'max_angle': 4, 'max_len': 50, 'max_width': 50, 'min_len': 30, 'min_width': 20, 'min_times': 1, 'max_times': 5}
        else:
        ...
        if box_kwargs is None:
            box_kwargs = {'margin': 10, 'bbox_min_size': 50, 'bbox_max_size': 150, 'min_times': 1, 'max_times': 3}
        else:
